...
trancengine: main.o
	$(CC) $(CFLAGS) $(INC_PATH) $(LDFLAGS) bin/main.o bin/Game.o bin/TextureManager.o bin/AssetManager.o bin/Collision.o bin/Map.o bin/Vector2D.o bin/ECS.o -o play

main.o: main.cpp bin/Game.o bin/TextureManager.o bin/AssetManager.o bin/Collision.o bin/Map.o bin/Vector2D.o bin/ECS.o
...
##bin/UIStatistics.o: UIStatistics.cpp UIStatistics.h
##	$(CC) $(CFLAGS) $(INC_PATH) UIStatistics.cpp -c -o bin/UIStatistics.o
